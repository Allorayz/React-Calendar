...
const Header = ({ 
	...
	const getCurrentWeekMonthPeriod = date => {
		...
		if(mondayMonth === sundayMonth) monthPeriod = `${mondayMonth} ${monday.year}`;
  ...
  return (
    <header className="header">
      <button 
			...
			>
        <i className="fas fa-plus create-event-btn__icon"></i>{language.translation('Create')}
      </button>
      <div className="navigation">
        ...
        <button onClick={showPrevWeek} className="icon-button navigation__nav-icon">
          <i className="fas fa-chevron-left"></i>
        </button>
        <button onClick={showNextWeek} className="icon-button navigation__nav-icon">
